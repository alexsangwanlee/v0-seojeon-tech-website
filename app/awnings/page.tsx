...
export default function AwningsPage() {
  ...
  const faqs = [
    ...
    {
      question: '원단 선택 가능한가요?',
      answer: '네, 가능합니다. Dickson(프랑스), Recasens(스페인), Letom(국내) 등 다양한 원단 브랜드를 선택할 수 있습니다. 설치 환경과 예산에 맞는 최적의 원단을 추천해드립니다.'
    },
    {
      question: '어닝 원단의 수명은 얼마나 되나요?',
      answer: 'Dickson, Recasens, Letom 등 원단 브랜드에 따라 다르며, 일반적으로 7~10년 사용 가능합니다. 서전텍 서비스 보증은 1년이며, 원단만 교체도 가능하여 경제적입니다.'
    },
    {
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="border-2 border-primary bg-primary/5 p-8">
                  ...
                  <ul className="space-y-3 mb-6">
                    ...
                    <li className="flex items-start gap-3">
                      <span className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0" />
                      <span className="text-sm"><strong>보증:</strong> 1년 서비스 보증</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0" />
